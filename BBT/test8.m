img1=imread('hobbit1.jpg')
img2=imread('hobbit4.jpg')
j=sum(imhist(img2))
[h2,h2r,h2g,h2b]=Hist(img2)
[h1,h1r,h1g,h1b]=Hist(img1)
r=bhattacharyya(h1r,h2r)
g=bhattacharyya(h1g,h2g)
b=bhattacharyya(h1b,h2b)
avgDist=(r+g+b)/3
